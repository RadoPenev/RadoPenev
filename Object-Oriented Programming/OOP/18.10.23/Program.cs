...
namespace _10._18._23
{
    class Program
    {
        public class Footbaler
        {
            ...
            public string Position { get { return position; } set { if (value == "defender" || value == "striker" || value == "midfielder" || value == "goalkeeper") { position = value; } else { Console.WriteLine("It needs to be defender,midfielder,striker or goalkeeper"); } } }
        ...
        public class Team
        {
            ...
            public void Print()
            {
                ...
                foreach (var item in footbalers)
                {
        ...
        static void Main(string[] args)
        {
            ...
            while (input[0].ToLower()!="end")
            {
                try
                {
                    ...
                    {
                        Footbaler fb = new Footbaler(input[1], input[2], input[3], Convert.ToInt32(input[4]));
                        team.AddPlayer(fb);
                    }
                    ...
                    if (input[0].ToLower()=="footbalgame")
                    {
                        team.FootballGame(input[1],Convert.ToInt32(input[2]));
                    }
                    if (input[0].ToLower() == "countplayers")
                    {
                        Console.WriteLine(team.CountPlayers(input[1]));
                    }
