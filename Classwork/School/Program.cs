...
namespace School
{
    class Program
    {
        static University university = new University("mg");
        static void Main(string[] args)
        {
            string[] line=Console.ReadLine().Split(' ');

            while ("END" != (line = Console.ReadLine().Split(' ')))
...

        {
            ...
            string[] info = University.ProvideInformationAboutAllStudents();
...

        {
            ...
            University.AddStudent(name, grade);
